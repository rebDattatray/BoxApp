...
public class PreviewVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rec_preview_video);
        ImageView storage=(ImageView) findViewById(R.id.preview);
        storage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PreviewVideo.this,PlayVideo.class);
