 ...
 */
public class ReceverAuto2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        splash.setImageResource(R.drawable.connection_process);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                /* Create an Intent that will start the Menu-Activity. */

                Intent mainIntent = new Intent(ReceverAuto2.this, ReceverAuto3.class);
